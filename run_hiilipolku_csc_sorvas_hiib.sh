#!/bin/bash -l
#SBATCH --job-name=susishiib
#SBATCH --output=/scratch/project_2002470/output/shiib_array_job_out_%A_%a.txt
#SBATCH --error=/scratch/project_2002470/error/shiib_array_job_err_%A_%a.txt
