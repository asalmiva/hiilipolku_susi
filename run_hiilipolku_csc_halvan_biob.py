...
#from susi_silvi_run_hiilipolku_halvan_biob import call_local_susi_motti_silvi_list
...
def get_paths():
    ...
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data_testaus/Halvanjoki/Halvanjoki_BIO_B/'
