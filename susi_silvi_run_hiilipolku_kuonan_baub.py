...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Kuonanjoki_BAU_B/' # outputs path
    wpath = r'/scratch/project_2002470/SUSI_HIILIPOLKU/inputs/' # weather data path
    #mottifolder = r'/scratch/project_2002470/SUSI_HIILIPOLKU/Kuonanjoki_BAU_B/'
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/Kuonanjoki_BAU_B/'
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Kuonanjoki_BAU_B/Kuonanjoki_BAU_B.txt'    
...
def get_motti_data():
    ...
    kuviot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/Kuonanjoki_BAU_B/motti/Kuonanjoki_BAU_B_kuviot.csv', encoding='latin1', sep=';')
    puustot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/Kuonanjoki_BAU_B/motti/Kuonanjoki_BAU_B_puustot.csv', encoding='latin1', sep=';')
    poistumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/Kuonanjoki_BAU_B/motti/Kuonanjoki_BAU_B_poistumat.csv', encoding='latin1', sep=';')
    tapahtumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/Kuonanjoki_BAU_B/motti/Kuonanjoki_BAU_B_tapahtumat.csv', encoding='latin1', sep=';', index_col=False)
    tulot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/Kuonanjoki_BAU_B/motti/Kuonanjoki_BAU_B_kasvut.csv', encoding='latin1', sep=';')
    
    return kuviot, puustot, poistumat, tapahtumat, tulot

def get_inputs():
        
    wdata='kuonanjoki_weathercont.csv' #'sorvasranta_weather.csv' #'puruvesi_saa_19810101-2020062.csv' #'halvansuo_weather.csv' #'kuonanjoki_weather.csv'# # # Weather data file name
