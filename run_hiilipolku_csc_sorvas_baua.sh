#!/bin/bash -l
#SBATCH --job-name=susisbaua
#SBATCH --output=/scratch/project_2002470/output/sbaua_array_job_out_%A_%a.txt
#SBATCH --error=/scratch/project_2002470/error/sbaua_array_job_err_%A_%a.txt
