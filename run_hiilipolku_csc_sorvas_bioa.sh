#!/bin/bash -l
#SBATCH --job-name=susisbioa
#SBATCH --output=/scratch/project_2002470/output/sbioa_array_job_out_%A_%a.txt
#SBATCH --error=/scratch/project_2002470/error/sbioa_array_job_err_%A_%a.txt
