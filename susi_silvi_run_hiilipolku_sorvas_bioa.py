...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Sorvasranta_BIO_A/' # outputs path
    wpath = r'/scratch/project_2002470/SUSI_HIILIPOLKU/inputs/' # weather data path
    #mottifolder = r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BIO_A/'
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BIO_A/'
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Sorvasranta_BIO_A/Sorvasranta_BIO_A.txt'    
...
def get_motti_data():
    ...
    kuviot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BIO_A/motti/Sorvasranta_BIO_A_kuviot.csv', encoding='latin1', sep=';')
    puustot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BIO_A/motti/Sorvasranta_BIO_A_puustot.csv', encoding='latin1', sep=';')
    poistumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BIO_A/motti/Sorvasranta_BIO_A_poistumat.csv', encoding='latin1', sep=';')
    tapahtumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BIO_A/motti/Sorvasranta_BIO_A_tapahtumat.csv', encoding='latin1', sep=';', index_col=False)
    tulot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BIO_A/motti/Sorvasranta_BIO_A_kasvut.csv', encoding='latin1', sep=';')
    
    return kuviot, puustot, poistumat, tapahtumat, tulot

def get_inputs():
        
    wdata='sorvasranta_weathercont.csv' #'sorvasranta_weather.csv' #'puruvesi_saa_19810101-2020062.csv' #'halvansuo_weather.csv' #'kuonanjoki_weather.csv'# # # Weather data file name
...
def call_local_susi_silvi(wdata, mottifile, sarkaSim, ageSim, sfc_mean, sfc_spec, site, break_vol, start_yr_arr, start_yr_ini, end_yr, vol_aft, susi_outfile, ash_year, peat_mass_inputs, peat_N_inputs, peat_P_inputs, peat_K_inputs, nutstat):
        ...
        while j < n_mottifiles:
            ...
            if n_mottifiles > 2:
                if j == n_mottifiles-1: # Jos tullaan viimeiseen motti-tiedostoon...
                    ...
                    new_end_yr, motti_found = call_susi_help(kuviot, stand, j, end_yr, start_yr_arr, wdata, sarka, break_vol, start_yr_ini, n_ditch_scens, np.nan, sfc_spec, ash_year=ash_year, vol_ini_0=vol_ini_0)   #np.nan oli ennen vol_after[j] 
