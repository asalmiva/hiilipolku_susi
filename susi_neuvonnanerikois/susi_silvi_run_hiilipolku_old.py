...
def get_paths():
    ...
    mottipath = r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BAU_A/'
...
def get_motti_data():
    ...
    kuviot = pd.read_csv(r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BAU_A/motti/Sorvasranta_BAU_A_kuviot.csv', encoding='latin1', sep=';')
    puustot = pd.read_csv(r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BAU_A/motti/Sorvasranta_BAU_A_puustot.csv', encoding='latin1', sep=';')
    poistumat = pd.read_csv(r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BAU_A/motti/Sorvasranta_BAU_A_poistumat.csv', encoding='latin1', sep=';')
    tapahtumat = pd.read_csv(r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BAU_A/motti/Sorvasranta_BAU_A_tapahtumat.csv', encoding='latin1', sep=';', index_col=False)
    tulot = pd.read_csv(r'/scratch/project_2002470/SUSI_HIILIPOLKU/Sorvasranta_BAU_A/motti/Sorvasranta_BAU_A_kasvut.csv', encoding='latin1', sep=';')
