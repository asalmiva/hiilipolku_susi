...
# =============================================================================
    # -------------- Parameters -----------------------------------------
        ...
        self.contpara = {'Mass': {1: {1:100., 2:100}, 2: {1:100., 2:100}, 3: {1:100., 2:100}, 4: {1:100., 2:100}, 5: {1:100., 2:100}},       ##tahan lisattiin ykkostyypia paikka  # Content of mass, N, P, K in peat, unit gravimettric %
                    'N':{1: {1:1.9, 2:1.9}, 2: {1:1.9, 2:1.9}, 3: {1:1.6, 2:1.6}, 4: {1:1.4, 2:1.4}, 5: {1:1.2, 2:1.2}},                # Unit gravimetric % Mese study           
                    'P':{1: {1:0.1,2:0.1}, 2: {1:0.1,2:0.1}, 3: {1:0.08, 2:0.08}, 4: {1:0.06, 2:0.06}, 5: {1:0.05, 2:0.05}}, 
                    'K':{1: {1:0.045, 2:0.045}, 2: {1:0.045, 2:0.045}, 3: {1:0.04, 2:0.038}, 4: {1:0.037, 2:0.034}, 5: {1:0.03, 2:0.03}}    
                    }
