...
for scen in scenarios:
    for sh in sheets:
        ...
        df = pd.read_excel(ifile, sheet_name=sh)
        df.to_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Kuonanjoki/'+scen+'/motti/'+scen+'_'+sh+'.csv', sep=';')
...
for scen in scenarios:
    for sh in sheets:
        ...
        df = pd.read_excel(ifile, sheet_name=sh)
        df.to_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Halvanjoki/'+scen+'/motti/'+scen+'_'+sh+'.csv', sep=';')
...
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_sorvas_baua.sh; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_sorvas_baub.sh;sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_sorvas_bioa.sh;
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_sorvas_biob.sh; sleep 45m; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_sorvas_hiia.sh; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_sorvas_hiib.sh; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_kuonan_baua.sh; sleep 2h; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_kuonan_baub.sh; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_kuonan_bioa.sh; sleep 2h; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_kuonan_biob.sh; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_kuonan_hiia.sh; sleep 2h; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_kuonan_hiib.sh; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_halvan_baua.sh; sleep 2h; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_halvan_baub.sh; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_halvan_bioa.sh; sleep 2h; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_halvan_biob.sh; 
sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_halvan_hiia.sh; sleep 2h; sbatch SUSI_HIILIPOLKU/run_hiilipolku_csc_halvan_hiib.sh
...
def create_motti_files_silvi(project, scen, maku=None):         # Huom! ohje>1
    ...
    kuviolista = list(set(kuviot['KUVIO'][kuviot['kuivatustilanne']>=3]))
    ...
    for i in range(0,len(kuviolista)):
        ...
        pdata = poistumat[(poistumat['KUVIO']==kuviolista[i]) & (poistumat['HARV']>1)]
            ...
            if ensihrow is None:
                ...
                # Muussa tapauksessa ikä löytyy riviä ylempää:
                    ...
                    if ensihrow>0:
                        ...
                        with open(outfile, "a") as myfile:
                            myfile.write('\nEnsiharvennuksen jälkeistä ikää ei löydy! i=' + str(i))
        ...
        for h in range(0,len(harv)):
            ...
            if hrow is None:
                ...
                # Muussa tapauksessa ikä löytyy riviä ylempää:
                    ...
                    # Jos ei löydy kummaltakaan puolelta:
                        with open(outfile, "a") as myfile:
                            myfile.write('\nHarvennuksen jälkeistä ikää ei löydy! i=' + str(i))
        ...
        if len(paateh)>0:
            ...
            if len(paateh)>1: # Jos useampi kuin yksi päätehakkuu
                ...
                if nonZeroRow is None:
                    with open(outfile, "a") as myfile:
                        myfile.write('\nPäätehakkuun jälkeisiä 0-rivejä ei saada korjattua! i=' + str(i)) #ää
