...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta_volnage/Halvanjoki_BIO_A/' # outputs path
    wpath = r'/scratch/project_2002470/SUSI_HIILIPOLKU/inputs/' # weather data path
    #mottifolder = r'/scratch/project_2002470/SUSI_HIILIPOLKU/Halvanjoki_BIO_A/'
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan_volnage/Halvanjoki/Halvanjoki_BIO_A/'
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta_volnage/Halvanjoki_BIO_A/Halvanjoki_BIO_A.txt'    
    outfol=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta_volnage/' # outputs path
...
def get_motti_data():
    ...
    kuviot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_A/motti/Halvanjoki_BIO_A_kuviot.csv', encoding='latin1', sep=';')
    puustot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_A/motti/Halvanjoki_BIO_A_puustot.csv', encoding='latin1', sep=';')
    poistumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_A/motti/Halvanjoki_BIO_A_poistumat.csv', encoding='latin1', sep=';')
    tapahtumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_A/motti/Halvanjoki_BIO_A_tapahtumat.csv', encoding='latin1', sep=';', index_col=False)
    tulot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_A/motti/Halvanjoki_BIO_A_kasvut.csv', encoding='latin1', sep=';')
