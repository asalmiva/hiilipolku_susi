...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta/Halvanjoki_BIO_A/' # outputs path
    ...
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_A/'
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta/Halvanjoki_BIO_A/Halvanjoki_BIO_A.txt'    
    outfol=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta/' # outputs path
