...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Sorvasranta_BAU_A/' # outputs path
    ...
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Sorvasranta_BAU_A/Sorvasranta_BAU_A.txt'    
