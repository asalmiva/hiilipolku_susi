...
def get_motti_data():
    ...
    kuviot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BAU_B/motti/Sorvasranta_BAU_B_kuviot.csv', encoding='latin1', sep=';')
    puustot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BAU_B/motti/Sorvasranta_BAU_B_puustot.csv', encoding='latin1', sep=';')
    poistumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BAU_B/motti/Sorvasranta_BAU_B_poistumat.csv', encoding='latin1', sep=';')
    tapahtumat = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BAU_B/motti/Sorvasranta_BAU_B_tapahtumat.csv', encoding='latin1', sep=';', index_col=False)
    tulot = pd.read_csv(r'/scratch/project_2002470/HIILIPOLKU_data/Sorvasranta/Sorvasranta_BAU_B/motti/Sorvasranta_BAU_B_kasvut.csv', encoding='latin1', sep=';')
