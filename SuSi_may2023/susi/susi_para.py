...
def get_susi_para(wlocation=None, peat=None, photosite='All data', folderName=None, hdomSim=None, volSim=None, 
                  ...
                  peatN=None, peatP=None, peatK=None, ash_year=None, sfc_spec=None):
    ...
    spara ={ 
        ...
        'pine_A':{
        'sitename': 'susirun',
        'species': 'Pine', 'sfc':sfc, 'sfc_specification': sfc_spec, 
        'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
        'nLyrs':50, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 

        'ditch depth west': [-0.3, -0.5, -0.7, -0.8], #7.3. muutettu 80cm ojiin
        'ditch depth east': [-0.3, -0.5, -0.7, -0.8], #7.3. muutettu 80cm ojiin
        'ditch depth 20y west': [-0.3, -0.5, -0.7, -0.8], #7.3. muutettu 80cm ojiin
        'ditch depth 20y east': [-0.3, -0.5, -0.7, -0.8], #7.3. muutettu 80cm ojiin 
        'scenario name': ['Ditch1','Ditch2','Ditch3', 'Ditch4', 'Ditch5', 'Ditch6'],
        ...
        'vonP bottom': 7, #7.3. muutettu Etel�-Savon ka mukaan aiempi 8
        ...
        'spruce_A':{
        'sitename': 'susirun',
        'species': 'Spruce', 'sfc':sfc, 'sfc_specification': sfc_spec,
        'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
        'nLyrs':50, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
        
        'ditch depth west': [-0.3, -0.5, -0.7, -0.8],   
        'ditch depth east': [-0.3, -0.5, -0.7, -0.8],
        'ditch depth 20y west': [-0.3, -0.5, -0.7, -0.8],
        'ditch depth 20y east': [-0.3, -0.5, -0.7, -0.8],        
        'scenario name': ['Ditch1','Ditch2','Ditch3', 'Ditch4', 'Ditch5', 'Ditch6'],
        ...
        'birch_A':{
        'sitename': 'susirun',
        'species': 'Birch', 'sfc':sfc, 'sfc_specification': sfc_spec,
        'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
        'nLyrs':50, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
        ...
        'ditch depth west': [-0.3, -0.5, -0.7, -0.8],   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
        'ditch depth east': [-0.3, -0.5, -0.7, -0.8],
        'ditch depth 20y west': [-0.3, -0.5, -0.7, -0.8],                                            #ojan syvyys 20 vuotta simuloinnin aloituksesta
        'ditch depth 20y east': [-0.3, -0.5, -0.7, -0.8],                                            #ojan syvyys 20 vuotta simuloinnin aloituksesta
