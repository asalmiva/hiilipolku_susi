...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta/Halvanjoki_BIO_B/' # outputs path
    ...
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan/Halvanjoki/Halvanjoki_BIO_B/'
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta/Halvanjoki_BIO_B/Halvanjoki_BIO_B.txt'    
