...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU/outputs/Kuonanjoki_HII_B/' # outputs path
    ...
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU/outputs/Kuonanjoki_HII_B/Kuonanjoki_HII_B.txt'    
