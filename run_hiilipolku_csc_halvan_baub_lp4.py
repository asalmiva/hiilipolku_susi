...
def get_paths():
    ...
    outPath=r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta_lp4/Halvanjoki_BAU_B/' # outputs path
    ...
    mottipath = r'/scratch/project_2002470/HIILIPOLKU_data/Neuvontaan_lp4/Halvanjoki/Halvanjoki_BAU_B/'
    outfile = r'/scratch/project_2002470/SUSI_HIILIPOLKU_outputs/Neuvonta_lp4/Halvanjoki_BAU_B/Halvanjoki_BAU_B.txt'    
