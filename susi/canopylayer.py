...
class Canopylayer():
    ...
    def __init__(self, name, nscens, yrs, ncols, nlyrs, sfc, agearr, mottipath, mottifile, ixs, photopara, nut_stat):
        ...
        self.photopara = photopara                                             # photosynthesis parameters for assimilation model (MÃ¤kelÃ¤ et al. 2008)
    ...
    def assimilate(self, forc, wt, afp, previous_nut_stat, nut_stat, lai_above):
        """
        Calls photosynthesis model (MÃ¤kelÃ¤ et al. 2008, standwise model) and leaf dynamics model that
    ...
    def leaf_dynamics(self, bm, bm_increment, current_leafmass, previous_nut_stat,\
        ...
        sla= {'Pine': 6.8, 'Spruce': 7.25, 'Birch':14.0}                       # specific leaf area HÃ¤rkÃ¶nen et al. 2015 BER 20, 181-195      
